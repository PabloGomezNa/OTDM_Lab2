...
data_file <- './raw_data/data_100.dat'  # Adjust the path as needed
...
w_ampl_C1 <- c(2.91592, 1.0833, 1.83498, 2.12442)
b_ampl_C1 <- -3.8438


#SVM weights and intercept for C=0.1
w_ampl_C0.1 <- c(1.00763, 0.503585, 0.636154, 0.815355)
b_ampl_C0.1 <- -1.59062


#SVM weights and intercept for C=100
w_ampl_C100 <- c(4.39543, 2.27533, 3.57151, 2.96796)
b_ampl_C100 <- -6.48459


#SVM weights and intercept for C=0.01
w_ampl_C0.01 <- c( 0.10711,0.05624, 0.06839,0.0824)
b_ampl_C0.01 <- -1.06058
...
# Transform  hyperplane (C=100)
transformed_C100 <- transform_hyperplane(w_ampl_C100, b_ampl_C100, pca_rot, pca_mean)
...
# Create meshgrid for  hyperplane (C=100)
grid_C100 <- create_meshgrid(w_pca_C100, b_pca_C100)
